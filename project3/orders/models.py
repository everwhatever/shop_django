...
from project3.utils import unique_order_id_generator
...
class Order(models.Model):
    ...
    status=models.CharField(max_length=160, default='created',choices=ORDER_STATUS_CHOICES)
    shipping_total=models.DecimalField(default=5.99,decimal_places=2,max_digits=10)
    total=models.DecimalField(default=5.99,decimal_places=2,max_digits=10)
